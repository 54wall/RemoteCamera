...
import com.hv.remote.wifi.WifiUtil;
...
public class MainActivity extends Activity {
    ...
    protected void onDestroy() {
        ...
        super.onDestroy();
        // 关闭wifi
        WifiUtil wifiSet = new WifiUtil(MainActivity.this);
        wifiSet.closeWifi();
        // 关闭热点
        WifiApUtil hpc = WifiApUtil.getInstance(this);
        try {
        ...
        switch (view.getId()) {
            ...
            case R.id.enterControlerBtn:
                ...
                if (wifiSet.isWifiConnected()) {
                    ...
                    startActivity(new Intent(this, com.hv.remote.ui.ControllerActivity.class));// 进入遥控界面
                } else {
                    // 进入系统wifi设置界面
                    showAlertDialog();
                }

...
public class BackgroundService extends Service {
        ...
        SurfaceHolder.Callback callback = new SurfaceHolder.Callback() {
            public void surfaceCreated(SurfaceHolder holder) {
                ...
                if (mCamera == null) {
                    ...
                    Toast.makeText(BackgroundService.this, getString(R.string.can_not_open_camera), Toast.LENGTH_SHORT).show();
                    stopSelf();
                ...
                try {
                    ...
                    Toast.makeText(BackgroundService.this, "SurfaceHolder is not available", Toast.LENGTH_SHORT).show();
                    stopSelf();
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        // We want BackgroundService.this service to continue running until it is
        // explicitly
    ...
    private void showNotification() {
        // In BackgroundService.this sample, we'll use the same text for the ticker and
...
//                       text, contentIntent);
    ...
    private void createOverlay() {
        ...
        WindowManager.LayoutParams params = new WindowManager.LayoutParams(1, 1, WindowManager.LayoutParams.TYPE_SYSTEM_OVERLAY,
                WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE | WindowManager.LayoutParams.FLAG_NOT_TOUCH_MODAL, // technically automatically set by
                // FLAG_NOT_FOCUSABLE
